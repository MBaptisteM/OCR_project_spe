                     ...
                     SDL_Rect *training_button, SDL_Rect *resolve_button)
{
    ...
    SDL_Texture *solverTex = SDL_CreateTextureFromSurface(*renderer, 
        solverSurf);
    SDL_Rect solverRect = {
    ...
    // ---------- TUTO ----------
    TTF_Font *tuto_font = TTF_OpenFont("INTERFACE/elements/text.TTF", 20);
    if (!tuto_font)
    ...
    TTF_Font *btnFont = TTF_OpenFont("INTERFACE/elements/tittle.TTF", 40);
    if (!btnFont)
